  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={clsx("text-xs leading-tight", isToday ? "text-brand-100" : "text-gray-400")}>
          {secondary}
        </p>
      </div>
      ...
      <div className="px-4 py-1">
        {entries.length === 0 ? (
          <p className="w-full py-4 text-sm text-gray-300 text-center">Nothing planned yet.</p>
        ) : (
