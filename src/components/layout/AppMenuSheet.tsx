        ...
        <div className="space-y-2 pb-2">
          ...
          {state.familyMembers.length > 0 && (
            <div className="flex flex-wrap gap-2 pt-1">
              {state.familyMembers.map((name) => (
                <div
                  key={name}
                  className="flex items-center gap-1.5 pl-3 pr-2 py-1.5 bg-gray-100 rounded-full"
                >
          ...
          <div className="flex gap-2 pt-1">
            <input
              ...
              className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:border-brand-400"
            />
            <button
